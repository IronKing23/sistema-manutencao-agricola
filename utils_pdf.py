...
# ==============================================================================
# 2. Relatório Geral (Paisagem - Página 1)
# ==============================================================================
...
def desenhar_grafico_barras(pdf, titulo, dados, y_pos, cor_barra=(100, 100, 100), max_w=180):
    ...
    """
    pdf.set_xy(10, y_pos)
    pdf.set_font('Helvetica', 'B', 10); pdf.set_text_color(0)
    pdf.cell(0, 8, titulo, 0, 1, 'L')
    
    if not dados:
        pdf.set_font('Helvetica', 'I', 9); pdf.cell(0, 6, "Sem dados.", 0, 1)
        return pdf.get_y() + 5
    ...
    for rotulo, valor in dados:
        ...
        # Volta para próxima linha
        pdf.set_xy(10, pdf.get_y() + bar_height)
        
    return pdf.get_y() + 8

# ==============================================================================
# 3. Relatório de KPIs (Página 15) -> ATUALIZADO
# ==============================================================================
# A função foi atualizada para aceitar o argumento opcional `graficos_data`
def gerar_relatorio_kpi(kpis, df_falhas, filtros_texto, graficos_data=None):
    ...
    if graficos_data:
        ...
        # 2. Top Máquinas
        if 'top_maquinas' in graficos_data:
